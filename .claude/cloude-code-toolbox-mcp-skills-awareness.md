...
_Generated: 2026-07-18T16:51:12.810Z_
...
Workspace `mcp.json` _(folder: posiongrowthleads)_

- **c:\Users\mello\posiongrowthleads\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\mello\.claude.json** — _File exists — no servers defined_
